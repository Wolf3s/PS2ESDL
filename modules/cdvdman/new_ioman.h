...
typedef struct _iop_device_ops {
	...
	int	(*open)(iop_file_t *, const char *, int); //different from iomanX
	...
	int	(*mkdir)(iop_file_t *, const char *); //different from iomanX
	int	(*rmdir)(iop_file_t *, const char *);
	int	(*dopen)(iop_file_t *, const char *);
	int	(*dclose)(iop_file_t *);
	int	(*dread)(iop_file_t *, fio_dirent_t *); /* changed *void to *fio_dirent_t */
	int	(*getstat)(iop_file_t *, const char *,fio_stat_t *); /* changed *void to *fio_stat_t */
